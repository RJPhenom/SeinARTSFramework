 ...
 *          pick the movement per unit via FSeinMovementData::MovementClass;
 ...
 * churn — movement subclasses just read what they care about and ignore
...
protected:
	 ...
	 *  ground-snap is the movement's job. */
	 ...
	 *  desired; falls back to MoveSpeed). Used by all vehicle movements to
	 ...
	 *  Caller is each movement's arrival branch (OR with bWithinAcceptance
