 ...
 * @file    SeinNavigationDefaultAStarAsset.h
 * @brief   Baked grid data for USeinNavigationDefaultAStar — single-layer 2D cell
...
#include "SeinNavigationDefaultAStarAsset.generated.h"
...
class SEINARTSNAVIGATION_API USeinNavigationDefaultAStarAsset : public USeinNavigationAsset
{
	GENERATED_BODY()
